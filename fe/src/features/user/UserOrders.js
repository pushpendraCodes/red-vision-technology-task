                ...
                {orders?.map((order) => (
                  <div className="gap-3">
                    <div className="flex justify-between">
                      ...
                      <button className={`rounded-md my-2  px-2 py-1 text-xs font-semibold text-white shadow-sm  ${order.status==="delivered"?"bg-green-400":"bg-red-400"}  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 `}>
                        {order.status}
                      </button>
                    </div>
